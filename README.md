...
Welcome to my GitHub profile! I'm a full-stack developer from Chile 🇨🇱 with a passion for creating web applications that make a difference. I specialize in **React** for frontend development and **Django** for the backend, deploying and managing applications on platforms like **Azure**.
